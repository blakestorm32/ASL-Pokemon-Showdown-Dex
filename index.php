...
<?php } ?>
	...
	<script src="/client/play.pokemonshowdown.com/js/client.js?0.10375585970917611"></script>
	<script src="/client/play.pokemonshowdown.com/config/config.js?0.1350350206870976"></script>
	<script src="/client/play.pokemonshowdown.com/js/battledata.js?0.5536139857279112"></script>
	<script src="/client/play.pokemonshowdown.com/data/search-index.js?0.8476818158123471"></script>
	<script src="/client/play.pokemonshowdown.com/data/pokedex.js?0.3407394902362164"></script>
	<script src="/client/play.pokemonshowdown.com/data/teambuilder-tables.js?0.4335613105331513"></script>
	<script src="/client/play.pokemonshowdown.com/data/learnsets.js?0.4354298518722115"></script>
	<script src="/client/play.pokemonshowdown.com/data/moves.js?0.9534158658180185"></script>
	<script src="/client/play.pokemonshowdown.com/data/abilities.js?0.24880047368507618"></script>
	<script src="/client/play.pokemonshowdown.com/data/items.js?0.14049600452837763"></script>
	<script src="/client/play.pokemonshowdown.com/data/formats-data.js?0.2498672174727612"></script>
	<script src="/client/play.pokemonshowdown.com/data/typechart.js?0.19878663815944542"></script>
	<script src="/client/play.pokemonshowdown.com/data/aliases.js?0.6998631648000346"></script>
	<script src="/client/play.pokemonshowdown.com/js/battle-dex-search.js?0.8881884080647435"></script>
	<script src="/client/play.pokemonshowdown.com/js/search.js?0.44909633823722483"></script>
